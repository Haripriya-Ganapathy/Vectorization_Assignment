...
int main(){
    ...
    std::cout<<"\nExecution Time for Scalar Integer Multiplication\t : "<< std::setprecision(4) << scalar_time.count()<<" microseconds\n" <<std::endl;
    ...
    std::cout<<"Execution Time for Vector 128-bit Integer Multiplication : "<< std::setprecision(4) << vector_time1.count()<<" microseconds\n" <<std::endl;
    ...
    std::cout<<"Execution Time for Vector 256-bit Integer Multiplication : "<< std::setprecision(4) << vector_time2.count()<<" microseconds\n" <<std::endl;
